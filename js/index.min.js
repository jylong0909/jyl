...
$(function() {
	(function() {
		...
		$('.W-introduce-me').on('click', function() {
			window.open('https://jylong0909.github.io')
		});
		...
		var sound = new Howl({
			src: ["http://localhost/html/audio/孙晨 - 拜托.mp3", ],
			autoplay: true,
			loop: true
		});
		...
		if(!!window.ActiveXObject || "ActiveXObject" in window) {
			...
			$('.W-introduce-me').css({
				'background': 'url("http://localhost/html/images/66.jpg") no-repeat',
		...
		var Imgatr = ["http://localhost/html/images/QQ图片20170420103507.gif"];
		var url = Imgatr[Math.floor(Math.random() * Imgatr.length)];
		// $('.W-yi-bg').css('background-image', 'url(' + url + ')');
		// if(url == "http://localhost/html/images/QQ图片20170420103507.gif") {
		// 	$('.Ws-tou').find('img').attr('src', 'http://localhost/html/images/QQ图片20170420103507.gif')
		// } else {
		// 	$('.Ws-tou').find('img').attr('src', 'http://localhost/html/images/QQ图片20170420103507.gif')
		// }
		var Wjn = [{
